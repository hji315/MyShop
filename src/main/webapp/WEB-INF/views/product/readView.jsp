...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#delete").on("click", function(){
			...
			if(deleteYN == true){
				formObj.attr("action", "${path}/product/delete");
		...
		$("#replyWriteBtn").on("click", function(){
			...
			formObj.attr("action", "${path}/product/replyWrite_qna");
			formObj.attr("method", "post");
			formObj.submit();
		});
	})
...
<body>
	...
	<div class="container">
		<table class="hjTable">
			<tr>
				<td colspan="2">
					<ul class="nav nav-tabs" style="text-align:center; width:700px;">
					...
					<td>
						<form name="replyForm" method="post">
							...
							<div class="form-floating" style="width:700px;">
								<textarea class="form-control" placeholder="Leave a comment here" id="qna" name="qna" style="height: 100px"></textarea>
								<label for="floatingTextarea2"><strong>${member.memberName}</strong></label>
								<button type="button" id="replyWriteBtn" class="btn btn-outline-secondary right">작성</button>
								<input type="hidden" id="writer" name="writer" value="${member.memberName}"/>
							</div>
						</form>
					</td>
				</tr>
				...
				<tr>
					<td>
						<div style="width:700px;">
							<input class="form-control" type="text" placeholder="로그인 후 이용해주세요" disabled>
						</div>
					</td>
				</tr>
			</c:if>

...
public class ProductController {
	...
	//QNA 작성
	@RequestMapping(value="/replyWrite_qna", method = RequestMethod.POST)
	public String replyWrite(ReplyVO vo, SearchCriteria scri, RedirectAttributes rttr) throws Exception {
		
		replyService.writeReply_qna(vo);
		rttr.addAttribute("product_id", vo.getProduct_id());
		
		return "redirect:/product/readView";
	}
	
	//리뷰 작성
	@RequestMapping(value="/replyWrite_review", method = RequestMethod.POST)
	public String replyWrite_review(ReplyVO vo, SearchCriteria scri, RedirectAttributes rttr) throws Exception {
		
		replyService.writeReply_review(vo);
		rttr.addAttribute("product_id", vo.getProduct_id());
		return "redirect:/product/readView";
	}
